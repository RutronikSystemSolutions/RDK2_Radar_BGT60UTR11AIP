...
This code example demonstrates digital signal processing implemented on a PSoC62 for use with the Infineon BGT60UTR11AIP radar sensor.
...
You can change the radar configuration used for measurement by generating a new "radar_settings.h" file.
...
Remark: the project uses 8-bit SPI transfer (instead of 12-bit transfer) to make it easier for integration with other microcontrollers (which do not support 12-bit transfer).
